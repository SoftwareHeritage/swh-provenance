...
use swh_provenance_db_build::dataset_writer::{ParallelDatasetWriter, ParquetTableWriter};
    ...
    <G as SwhGraphWithProperties>::Maps: swh_graph::properties::Maps,
{
    ...
    par_iter_shuffled_range(0..graph.num_nodes()).try_for_each(|root| -> Result<()> {
        let search_in_node = match node_filter {
            NodeFilter::All => true,
            NodeFilter::Heads => swh_provenance_db_build::filters::is_head(graph, root),
        };
